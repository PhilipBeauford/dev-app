(() => {
  ...
  // extensions/banner-test/node_modules/@remote-ui/core/build/esm/component.mjs
  function createRemoteComponent(componentType) {
    return componentType;
  }

  // extensions/banner-test/node_modules/@remote-ui/core/build/esm/types.mjs
  var ACTION_MOUNT = 0;
  ...
  // extensions/banner-test/node_modules/@remote-ui/core/build/esm/utilities.mjs
  function isRemoteFragment(object) {
    return object != null && object.kind === KIND_FRAGMENT;
  }

  // extensions/banner-test/node_modules/@remote-ui/core/build/esm/root.mjs
  ...
  // extensions/banner-test/node_modules/@shopify/ui-extensions/build/esm/utilities/registration.mjs
  ...
  // extensions/banner-test/node_modules/@shopify/ui-extensions/build/esm/surfaces/checkout/extension.mjs
  var extension = createExtensionRegistrationFunction();

  // extensions/banner-test/node_modules/@shopify/ui-extensions/build/esm/surfaces/checkout/components/Banner/Banner.mjs
  var Banner = createRemoteComponent("Banner");

  // extensions/banner-test/src/Checkout.js
  var Checkout_default = extension(
    "purchase.checkout.block.render",
    (root, { settings }) => {
      var _a;
      const { status, collapsible, description } = settings.current;
      const title = (_a = settings.current.title) != null ? _a : "Custom Banner";
      ...
      settings.subscribe((newSettings) => {
        var _a2;
        banner.updateProps({
          title: (_a2 = newSettings.title) != null ? _a2 : "Custom Banner",
